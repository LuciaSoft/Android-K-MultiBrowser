...
internal object ListUtils
{
    ...
    ): ArrayList<DirectoryItem>?
    {
        ...
        for (item in items)
        {
            ...
            if (isFile &&
                (!act.ADV.showFilesInNormalView || act.OPT.browseMode == BrowseMode.LoadFolders || act.OPT.browseMode == BrowseMode.SaveFolders)) continue
...
internal class DirItemComparator(private var order: SortOrder) : Comparator<DirectoryItem>
{
